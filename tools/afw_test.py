...
parser = argparse.ArgumentParser(description='pyramidbox evaluatuon afw')
parser.add_argument('--model', 
					type=str,default='weights/pyramidbox.pth', help='trained model')
...
AFW_RESULT_DIR = os.path.join(cfg.FACE.AFW_DIR, 'pyramidbox')
...
if __name__ == '__main__':
    ...
    counter = 0
    txt_out = os.path.join(AFW_RESULT_DIR, 'pyramidbox_dets.txt')
